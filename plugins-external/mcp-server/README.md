# Yapi MCP Server Plugin

Exposes Yapi's functionality via the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/).
...
Restart Claude Desktop and make sure Yapi is running.
...
- `show_toast` - Show a toast notification in Yapi
